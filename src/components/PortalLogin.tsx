...
export default function PortalLogin({ onLogin, portalType: initialPortalType = 'student' }: PortalLoginProps = {}) {
  const [portalType, setPortalType] = useState<"student" | "parent" | "teacher">(initialPortalType);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          />
          <h2 className="mt-6 text-3xl font-bold text-gray-900">ADJIS Portal Login</h2>
